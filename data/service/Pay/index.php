...
：</dt>
        ...
        <form name=tradequery action=query.php method=post target="_blank">
...
：</dt>
        ...
        <form name=traderefund action=refund.php method=post target="_blank">
...
：</dt>
        ...
        <form name=traderefundquery action=refundquery.php method=post target="_blank">
...
：</dt>
        ...
        <form name=tradeclose action=close.php method=post target="_blank">
