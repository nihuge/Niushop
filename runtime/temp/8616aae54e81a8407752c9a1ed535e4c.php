...
<div class="set-style">
	<dl>
		<dt>APP ID：</dt>
		<dd>
			<input id="app_id" type="text" value="<?php echo $config['value']['app_id']; ?>" class="input-common long" />
			<p class="hint">应用ID</p>
		</dd>
	</dl>
	<dl>
		<dt>应用私钥：</dt>
		<dd>
			<textarea id="merchant_private_key" class="textarea-common big"><?php echo $config['value']['merchant_private_key']; ?></textarea>
	...
	<dl>
		<dt>RSA2公钥：</dt>
		<dd>
			<textarea id="alipay_public_key" class="textarea-common big"><?php echo $config['value']['alipay_public_key']; ?></textarea>
