		...
		<tr data-flag="<?php echo $vo['id']; ?>">
			<td align="center">
				<div class="shop_service_item" >
					...
					<?php else: ?>
					<img src="<?php echo __IMG($vo['pic']); ?>" id="imglogo<?php echo $key; ?>" style="cursor: pointer;width:28px;height:28px;" class="black_data">
