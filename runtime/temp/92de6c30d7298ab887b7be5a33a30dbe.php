<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue/Extend/hooksList.html";i:1522723198;s:28:"template/adminblue/base.html";i:1526106064;s:45:"template/adminblue/controlCommonVariable.html";i:1522486340;s:32:"template/adminblue/urlModel.html";i:1510819828;s:34:"template/adminblue/pageCommon.html";i:1525347460;s:34:"template/adminblue/openDialog.html";i:1522669942;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	<button class="btn-common" onclick="location.href='<?php echo __URL('ADMIN_MAIN/extend/addhooks'); ?>';">添加钩子</button>
</div>
		...
		success : function(data) {
			if (data['data'].length > 0) {
				...
				for (var i = 0; i < data['data'].length; i++) {
					...
					html += '<td align="center"><a href="'+__URL('ADMIN_MAIN/extend/updatehooks?id='+data['data'][i]['id'])+'" style="margin-left:0;">修改</a><a href="javascript:;" onclick="deleteHooks('+ data['data'][i]['id'] +')">删除</a></td>';
					html += '</tr>';
				...
				$.ajax({
					...
					success : function(data) {
						if(data['code'] > 0){
							...
							location.href = "<?php echo __URL('ADMIN_MAIN/extend/hookslist'); ?>";
						}else{
