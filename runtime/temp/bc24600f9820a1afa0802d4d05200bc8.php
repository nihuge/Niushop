<?php if (!defined('THINK_PATH')) exit(); /*a:12:{s:40:"template/shop/blue/Goods/couponList.html";i:1534929054;s:28:"template/shop/blue/base.html";i:1538980490;s:32:"template/shop/blue/urlModel.html";i:1510819884;s:34:"template/shop/blue/controlTop.html";i:1511140622;s:41:"template/shop/blue/controlHeadSerach.html";i:1530169694;s:43:"template/shop/blue/controlHeadGoodType.html";i:1506594224;s:40:"template/shop/blue/controlCommonNav.html";i:1502706000;s:43:"template/shop/blue/controlRightSidebar.html";i:1538980490;s:45:"template/shop/blue/controlBottomLinkHelp.html";i:1526635356;s:37:"template/shop/blue/controlBottom.html";i:1512179372;s:36:"template/shop/blue/controlLogin.html";i:1508897748;s:37:"template/shop/blue/baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- 		<?php if(is_array($category_name)): ?> -->
<!-- 			<?php foreach($category_name as $vo): ?> -->
<!-- 				&nbsp;<span class="crumbs-arrow">首页  ></span>&nbsp;<a href="<?php echo __URL('SHOP_MAIN/goods/couponList','category_id='.$vo['category_id']); ?>">优惠券</a> -->
<!-- 			<?php endforeach; ?> -->
<!-- 		<?php else: ?> -->
<!-- 			&nbsp;<span class="crumbs-arrow">></span>&nbsp;<?php echo $category_name; ?> -->
<!-- 		<?php endif; ?> -->
			&nbsp;<span class="crumbs-arrow"><a href="<?php echo __URL('SHOP_MAIN','category_id='.$vo['category_id']); ?>">首页 </a> ></span>&nbsp;<a href="<?php echo __URL('SHOP_MAIN/goods/couponList','category_id='.$vo['category_id']); ?>">优惠券</a>
		</span>	
	</div>
	...
	<div class="tip-box" style="text-align: center;">
		<img src="__TEMP__/<?php echo $style; ?>/public/images/no_coupons.png"/>
		<div class="tip-text" style="padding: 10px 0;"><?php echo lang('no_coupons'); ?>……</div>
	</div>
	<?php endif; ?>
...
/* 优惠券懒加载 */
var page = 2;
var href = '<?php echo __URL('SHOP_MAIN/goods/couponlist.html?page='); ?>';
var is_scroll = true;
...
function coupon_receive(event,coupon_type_id){
	if(is_have){
		...
		$.ajax({
			type:"post",
			url : "<?php echo __URL('SHOP_MAIN/goods/getCoupon'); ?>",
			async: true,
			dataType:"json",
