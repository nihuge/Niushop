<?php
//000000000000a:3:{s:11:"orderAction";s:47711:"<style>
...
$(function() {
	...
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/getprovince",
		dataType : "json",
...
function orderDelivery(order_id){
	...
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/orderdeliverydata",
		...
		success : function(data) {
			...
			for(var i=0;i<data['order_goods_list'].length;i++){
				...
				go_html += '<td><a href="'+__URL('http://shop.0csy.com/index.php/goods/goodsinfo?goodsid='+data['order_goods_list'][i]['goods_id'])+'" target="_blank"><img src="'+__IMG(data['order_goods_list'][i]['picture_info']['pic_cover_micro'])+'" style="width:40px;" title="'+data['order_goods_list'][i]['goods_name']+'"></a></td>';
				go_html += '<td style="text-align:left;"><a href="'+__URL('http://shop.0csy.com/index.php/goods/goodsinfo?goodsid='+data['order_goods_list'][i]['goods_id'])+'" target="_blank">'+data['order_goods_list'][i]['goods_name'];
...
function orderDeliverySubmit(){
	...
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/orderdelivery",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
					$.ajax({
						type : "post",
						url : "http://shop.0csy.com/index.php?s=/admin/order/orderofflinepay",
						data : {'order_id':order_id},
						success : function(data) {
							if (data["code"] > 0) {
								showMessage('success', data["message"],window.location.reload());
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
					$.ajax({
						type : "post",
						url : "http://shop.0csy.com/index.php?s=/admin/orderpresell/presellOrderOffLinePay",
...
function orderComplete(order_id){
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/ordercomplete",
		data : {'order_id':order_id},
		success : function(data) {
...
function orderClose(order_id){
	$( "#dialog" ).dialog({
		buttons: {
			...
			$.ajax({
				type : "post",
				url : "http://shop.0csy.com/index.php?s=/admin/order/orderclose",
				data : {"order_id" : order_id},
				success : function(data) {
					if(data["code"] > 0 ){
						LoadingInfo(1);
...
function modifyPrice(order_id,orderFreight){
	...
	$.ajax({
		type: "post",
		url: "http://shop.0csy.com/index.php?s=/admin/order/getordergoods",
		data: { "order_id": order_id },
		dataType: "json",
		async: false,
		success: function (jsonData) {
			...
			for (var i = 0 ; i < jsonData.length; i++) {
				...
				str += "<a class='name' href="+__URL('http://shop.0csy.com/index.php/wap?id='+jsonData[i].goods_id)+" target='_blank'>" + jsonData[i].goods_name + "</a>";
...
function updPrice(){
	...
	$.ajax({
		type: "post",
		url: "http://shop.0csy.com/index.php?s=/admin/order/orderadjustmoney",
...
function orderSellerMemo(order_id){
	$.ajax({
		type : 'post',
		url : "http://shop.0csy.com/index.php?s=/admin/order/getordersellermemo",
		data : { "order_id" : order_id },
...
function orderPickupSubmit(){
	...
	$.ajax({
		type: "post",
		url: "http://shop.0csy.com/index.php?s=/admin/order/pickuporder",
...
function update_address(order_id){
	$.ajax({
		type : 'post',
		url : "http://shop.0csy.com/index.php?s=/admin/order/getOrderUpdateAddress",
		data : { "order_id" : order_id },
		success : function(data){
...
function updateAddressSubmit(){
	...
	$.ajax({
		type : 'post',
		url : "http://shop.0csy.com/index.php?s=/admin/order/updateOrderAddress",
		data : {
			"order_id" : order_id,
...
function GetProvince() {
	...
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/getcity",
		dataType : "json",
		data : {
			"province_id" : id
		},
...
function getSelCity() {
	...
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/getdistrict",
		dataType : "json",
		data : {
			"city_id" : id
		},
...
function addMemoAjax(){
	...
	$.ajax({
		url: "http://shop.0csy.com/index.php?s=/admin/order/addmemo",
...
function getdelivery(order_id){
	$.ajax({
		url: "http://shop.0csy.com/index.php?s=/admin/order/orderTakeDelivery",
		data: { "order_id": order_id },
		type : "post",
		success: function(data) {
			if (data.code > 0) {
...
function delete_order(order_id){
	$( "#dialog" ).dialog({
		buttons: {
			...
			$.ajax({
				type : "post",
				url : "http://shop.0csy.com/index.php?s=/admin/order/deleteOrder",
				...
				success : function(data) {
					if(data["code"] > 0 ){
						if(typeof LoadingInfo !="undefined"){
							...
							showMessage('success', data["message"], "http://shop.0csy.com/index.php?s=/admin/order/orderlist");
						}	
					}
				}
			})
...
function updateExpressAjax(){
		...
		$.ajax({
			type : "post",
			url : "http://shop.0csy.com/index.php?s=/admin/order/updateOrderExpress",
...
function o2o_delivery(order_id){
	...
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/o2odeliverydata",
		data : {'order_id':order_id},
		success : function(data) {
			$("#delivery_order_id").val(order_id);
			var receiver_info = '收货信息：'+data['order_info']['address']+'&nbsp;'+data['order_info']['receiver_address']+'&nbsp;'+data['order_info']['receiver_name']+'&nbsp;'+data['order_info']['receiver_mobile'];//收货信息
...
function o2oDeliverySubmit(){
	...
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/o2odelivery",
		data : {
			'order_id':order_id,
...
function presellStockingComplete(order_id){
	$( "#dialog" ).dialog({
		buttons: {
			...
			$.ajax({
				type : "post",
				url : "http://shop.0csy.com/index.php?s=/admin/Orderpresell/orderStockingComplete",
				data : {"order_id" : order_id},
				success : function(data) {
					if(data["code"] > 0 ){
						LoadingInfo(1);
...
function received_payment(order_id){
	$( "#dialog" ).dialog({
		buttons: {
			...
			$.ajax({
				type : "post",
				url : "http://shop.0csy.com/index.php?s=/admin/order/received_payment",
				data : {"order_id" : order_id},
				success : function(data) {
					if(data["code"] > 0 ){
						LoadingInfo(1);
...
</script>";s:16:"orderPrintAction";s:31192:"<style>
.cell .is_Increment{
	margin-left: 10px;
}	
.is_Increment{
	...
	<div class="modal-body" style="height: 282px; overflow: auto;">
		<form class="form-horizontal">
			<div class="control-group">
				...
				<span><a href="http://shop.0csy.com/index.php?s=/admin/express/expresscompany" class="goToConfigure" style="text-decoration: underline;">前去配置</a></span>
			</div>
		</form> 
		<div class="ordercontent">
			<div class="data-body-head">
...
function showInvoice() {
	...
	$.ajax({
		url: "http://shop.0csy.com/index.php?s=/admin/order/getOrderInvoiceView",
		data: { "ids": strIDs },
		async: false, // 让它同步执行
		dataType: "json",
	...
	$.ajax({
		type: "post",
		url: "http://shop.0csy.com/index.php?s=/admin/order/getshopinfo",
		dataType: "json",
		data: "oper=getType",
...
function invoicePrinPreview(ids) {
	...
	if (ids != "") {
		$("#invoicePrintingURL").attr("href", __URL("http://shop.0csy.com/index.php/admin/order/printdeliverypreview?order_ids=" + ids + "&ShopName=" + ShopName + ""));
...
function printPreview() {
	...
	for (var i = 0; i < checks.length; i++) {
		...
		if (check == true) {
			...
			$.ajax({
				url: "http://shop.0csy.com/index.php?s=/admin/order/printpreviewvalidate",
	...
	if (printQueue.length > 0) {
		$("#expressSinglePrintURl").attr("href", __URL("http://shop.0csy.com/index.php/admin/order/printexpresspreview?expressIDs=" + printQueue + "&sid="+$("#expressTemplate").val()));
...
function printShipping(){
	...
	$.ajax({
		type : "post",
		url: "http://shop.0csy.com/index.php?s=/admin/order/getShippingList",
...
function printpreviewOfInvoice(){
	...
	if (order_ids != "") {
		window.open('http://shop.0csy.com/index.php?s=/admin/order/printpreviewOfInvoice&order_ids='+order_ids +'');
	}
}
...
function showExpress() {
	...
	$("#print_select_ids").val(strIDs);
	$.ajax({
		url: "http://shop.0csy.com/index.php?s=/admin/order/getorderexpresspreview",
		data: { "ids": strIDs },
		async: false, // 让它同步执行
		dataType: "json",
		success: function (data) {
...
function expressPrinPreview(ids) {
	...
	if(expressno_is_empty){
		$.ajax({
			type : "post",
			url : 'http://shop.0csy.com/index.php?s=/admin/order/addTmpExpressInformation',
		...
		if (print_order_ids != "") {
			window.open(__URL("http://shop.0csy.com/index.php/admin/order/printexpresspreview?print_order_ids=" + print_order_ids));
		}
	}
}  
...
function showNotShippingOrderList(){
	...
	$.ajax({
		type : "post",
		url: "http://shop.0csy.com/index.php?s=/admin/order/getNotshippedOrderList",
		data: { "ids": strIDs },
		async: false, // 让它同步执行
		dataType: "json",
		success: function (data) {
...
$("#PrintOrder").click(function(){
	...
	if (BatchSend.length == 0) {
		...
		window.open(__URL("http://shop.0csy.com/index.php/admin/order/printOrder?print_order_ids=" + BatchSend.toString()));
	}
})
</script>";s:17:"orderRefundAction";s:10452:"<link rel="stylesheet" href="/public/admin/css/order_refunds.css">
...
function refuseRefundType(type){
	...
	if(type == 1){
		refund_url = "http://shop.0csy.com/index.php?s=/admin/order/ordergoodsrefuseonce";
	} else{
		refund_url = "http://shop.0csy.com/index.php?s=/admin/order/ordergoodsrefuseforever";
	}
	$.ajax({
		type : "post",
		url : refund_url,
...
function orderGoodsConfirmRecieve(order_id,order_goods_id){
	...
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/getOrderGoodsDetialAjax",
...
function confirm_receipt(){
	...
	$.ajax({
		type : "post",
		url : "http://shop.0csy.com/index.php?s=/admin/order/ordergoodsconfirmrecieve",
